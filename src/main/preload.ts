...
const electronAPI: IElectronAPI = {
  ...
  login: (homeserver: string, username: string, password: string) => 
    ipcRenderer.invoke('auth:login', homeserver, username, password),
  register: (homeserver: string, username: string, password: string, email?: string) => 
    ipcRenderer.invoke('auth:register', homeserver, username, password, email),
  ...
  saveCredentials: (homeserver: string, userId: string, accessToken: string) => 
    ipcRenderer.invoke('auth:save-credentials', homeserver, userId, accessToken),
